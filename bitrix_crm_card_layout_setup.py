...
# ВНИМАНИЕ: `--apply` больше запускать нельзя без отдельного решения владельца.
# После настройки обязательности по стадиям Bitrix24 сам поднял девять полей в
# главный раздел карточки «О сделке». Владелец принял эту раскладку. Запуск с
# `--apply` вернёт поля в проектные разделы и будет воевать с Bitrix24.
# Режим плана без флага безопасен: он только читает.
